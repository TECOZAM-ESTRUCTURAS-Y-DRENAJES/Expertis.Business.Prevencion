...
Public Class ObraComunicadoTipo
    ...
    Private Const cnEntidad As String = "tbObraComunicadoTipo"
...
#Region " RegisterValidateTasks "
    ...
    <Task()> Public Shared Sub ValidarCamposObligatorios(ByVal data As DataRow, ByVal services As ServiceProvider)
        If Solmicro.Expertis.Engine.Length(data("idtipo")) = 0 Then ApplicationService.GenerateError("El código del tipo de comunicado es un dato obligatorio.")

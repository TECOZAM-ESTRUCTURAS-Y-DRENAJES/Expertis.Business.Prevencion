...
Public Class PrevencionRecoPuesto
    ...
    Private Const cnEntidad As String = "tbOperarioPuesto"
...
#Region "RegisterAddNewTasks"
    ...
    <Task()> Public Shared Sub AsignarValoresPredeterminados(ByVal data As DataRow, ByVal services As ServiceProvider)
        data("idRecoPuesto") = AdminData.GetAutoNumeric
...
#Region " RegisterValidateTasks "
    ...
    <Task()> Public Shared Sub ValidarCamposObligatorios(ByVal data As DataRow, ByVal services As ServiceProvider)
        If Solmicro.Expertis.Engine.Length(data("idRecoPuesto")) = 0 Then ApplicationService.GenerateError("El código de la puesto de obra es un dato obligatorio.")

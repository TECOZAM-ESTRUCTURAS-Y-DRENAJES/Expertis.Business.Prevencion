...
Public Class PrevencionComboEpi
    ...
    Private Const cnEntidad As String = "tbOperarioEpisTipo"
...
#Region "RegisterAddNewTasks"
    ...
    <Task()> Public Shared Sub AsignarValoresPredeterminados(ByVal data As DataRow, ByVal services As ServiceProvider)
        data("idEpisTipo") = AdminData.GetAutoNumeric
...
#Region " RegisterValidateTasks "
    ...
    <Task()> Public Shared Sub ValidarCamposObligatorios(ByVal data As DataRow, ByVal services As ServiceProvider)
        If Solmicro.Expertis.Engine.Length(data("idEpisTipo")) = 0 Then ApplicationService.GenerateError("El código del tipo de epi es un dato obligatorio.")
...
#End Region
    ...
    Friend Sub AdminComboEpi(ByVal sEpi As String)
        Try
            Dim DtAdmin As DataTable
            Dim FAdmin As New Filter
            Dim De As New DataEngine
            FAdmin.Add("DescEpi", sEpi.ToUpper)
            DtAdmin = De.Filter("tbOperarioEpisTipo", FAdmin, "DescEpi", False)
            ...
            If IsNothing(DtAdmin) OrElse DtAdmin.Rows.Count = 0 Then
                ...
                DtAdmin.Rows(0)("idEpisTipo") = AdminData.GetAutoNumeric()
                DtAdmin.Rows(0)("DescEpi") = sEpi.ToUpper
